...
import com.hospitalcm.DAO.mdDetailsDAO;
...
public class mdDetailsApi {
    mdDetailsDAO objUse = new mdDetailsDAO();
    
    /*Método POST: Utilizado para insertar una consulta medica en la tabla de
                   base de datos correspondiente
    */
    @POST
    public Response agregar(mdDetailsModel registro) throws SQLException{
    ...
    */
    @GET
    public List<mdDetailsModel> todos(){
    ...
    */
    @PUT
    public Response actualizar(mdDetailsModel registro) throws SQLException{
